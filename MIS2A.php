...
<head>
	...
	<style type="text/css">
		* { font-family:"標楷體"; margin-left:auto; margin-right:auto;}
		...
		h2 {color:#45AA78; font-size:40px;}
	</style>
	<script>
		function change1() {
		...
		function change2() {
  			...
  			document.getElementById("h2text").innerText = "Kuo-Hao-Cheng";
		}
	</script>
...
<body>
	...
	<table width="100%">
		<tr>
			<td>
				<img src="cliff.jpg" width="50%"id="pic" onmouseover="change1()" onmouseout="change2()"></img>
			</td>

			<td>
				<h1>郭澔澄</h1>
				<h2 id="h2text">Kuo-Hao-Cheng</h2>
			</td>
		</tr>
	</table>
<table width="70%" border="1">
    ...
    <td>
	不要去臺灣<br>
	<iframe src="https://www.youtube.com/embed/pW88QFpHXa8" allowfullscreen></iframe></td>
</body>
</html>